...
import { BookOpen, Headphones, MessageSquare, Pencil, Trophy, Target, ChevronRight, Bell, Settings } from "lucide-react";
          ...
          <div className="px-6 py-4">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex-1 max-w-md">
                <XPBar currentXP={1250} requiredXP={2000} level={8} />
              </div>

              {/* Right Section */}
              <div className="flex items-center gap-3">
                <StreakCounter streak={12} isActive={true} />
